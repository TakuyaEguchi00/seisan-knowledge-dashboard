...
図表の集計は **受注日が 2023年3月1日〜2026年2月28日まで（暦で丸3年）** に入る成約のみです（`ナレッジ/成約分析` の個別 `.md`、サマリー除外）。**2023年3月〜2024年2月**は当フォルダに該当ファイルが無く **0件** の月として表に出ます。再集計の参照用スクリプト: **`scripts/dashboard-aggregate-3y.mjs`**（`node scripts/dashboard-aggregate-3y.mjs`）。
